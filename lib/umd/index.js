(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('bbmn-utils'), require('bbmn-core')) :
	typeof define === 'function' && define.amd ? define(['exports', 'bbmn-utils', 'bbmn-core'], factory) :
	(factory((global.bbmn = global.bbmn || {}, global.bbmn.components = {}),global.bbmn.utils,global.bbmn));
}(this, (function (exports,bbmnUtils,bbmnCore) { 'use strict';
...
Process$2.register = function (context, name, opts) {
	return register(this, context, name, opts);
};
...
var StartableMixin = (function (Base) {
	return Base.extend({
		...
		_initializeStartable: function _initializeStartable() {
			...
			Process$2.register(this, 'start', start);
			Process$2.register(this, 'stop', stop);
