(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('underscore'), require('bbmn-utils'), require('bbmn-core')) :
	typeof define === 'function' && define.amd ? define(['exports', 'underscore', 'bbmn-utils', 'bbmn-core'], factory) :
	(factory((global.bbmn = global.bbmn || {}, global.bbmn.components = {}),global._,global.bbmnUtils,global.bbmnCore));
}(this, (function (exports,_,bbmnUtils,bbmnCore) { 'use strict';
...
var App = BaseApp.extend({
	...
	buildRegion: function buildRegion() {
		var region = this.getOption('region', { args: [this] }) || {};
		var el = this.getOption('appEl') || 'body';
		var replaceElement = true;
		var opts = { el: el, replaceElement: replaceElement };
		var RegionClass = bbmnCore.Region;

		if (bbmnCore.isClass(region, bbmnCore.Region)) {
			RegionClass = region;
			region = {};
		} else if (_.isFunction(region)) {
			var runtime = region.call(this, this);
			if (bbmnCore.isClass(runtime, bbmnCore.Region)) {
				RegionClass = runtime;
				region = {};
			} else {
				region = runtime;
		...
		var options = _.pick(_.extend(opts, region), 'regionClass', 'el', 'replaceElement');

		if (bbmnCore.isClass(options.regionClass, bbmnCore.Region)) {
