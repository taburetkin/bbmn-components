...
var ExtView = bbmnUtils.mix(backbone_marionette.View).with(bbmnMixins.optionsMixin, bbmnMixins.cssClassModifiersMixin);

var ExtCollectionVIew = bbmnUtils.mix(backbone_marionette.CollectionView).with(bbmnMixins.optionsMixin, bbmnMixins.cssClassModifiersMixin, bbmnMixins.customsMixin, bbmnMixins.emptyFetchMixin, bbmnMixins.improvedIndexesMixin);
...
var actionableMixin = (function (Base) {
	return Base.extend({
		...
		_isActionsRegistered: function _isActionsRegistered() {
			return store$3.isExists(this);
		},
