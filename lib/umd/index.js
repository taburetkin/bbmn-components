(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('underscore'), require('bbmn-utils'), require('bbmn-core'), require('backbone.marionette'), require('bbmn-mixins')) :
	typeof define === 'function' && define.amd ? define(['exports', 'underscore', 'bbmn-utils', 'bbmn-core', 'backbone.marionette', 'bbmn-mixins'], factory) :
	(factory((global.bbmn = global.bbmn || {}, global.bbmn.components = {}),global._,global.bbmnUtils,global.bbmnCore,global.backbone_marionette,global.bbmnMixins));
}(this, (function (exports,_,bbmnUtils,bbmnCore,backbone_marionette,bbmnMixins) { 'use strict';
