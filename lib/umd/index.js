(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('underscore'), require('bbmn-utils'), require('bbmn-core'), require('backbone.marionette'), require('bbmn-mixins'), require('backbone')) :
	typeof define === 'function' && define.amd ? define(['exports', 'underscore', 'bbmn-utils', 'bbmn-core', 'backbone.marionette', 'bbmn-mixins', 'backbone'], factory) :
	(factory((global.bbmn = global.bbmn || {}, global.bbmn.components = {}),global._,global.bbmn.utils,global.bbmn,global.Mn,global.bbmn.mixins,global.Backbone));
