...
import { betterResult, buildViewByKey, camelCase, clone, getByPath, getOption, isEmptyValue, isViewClass, mergeOptions, mix, renderInNode, takeFirst, triggerMethod, triggerMethodOn } from 'bbmn-utils';
...
import { cssClassModifiersMixin, customsMixin, destroyViewMixin, emptyFetchMixin, improvedIndexesMixin, nextCollectionViewMixin } from 'bbmn-mixins';
import Backbone, { Collection as Collection$1 } from 'backbone';
import $ from 'jquery';
...
var ExtView = mix(View).with(cssClassModifiersMixin, common);

var ExtCollectionVIew = mix(CollectionView).with(cssClassModifiersMixin, customsMixin, emptyFetchMixin, improvedIndexesMixin, common);
...
export { Process, startableMixin, App, store as ModelSchemas, ModelSchema, PropertySchema, validator, User, Token as BearerToken, Stack as ViewStack, store$1 as store, ExtView as View, ExtCollectionVIew as CollectionView, AtomText as AtomTextView, notify, notifies, Notifier, Action, store$3 as ActionStore, actionableMixin, action, modals, Selector };
