...
import { BaseClass, Events, Model, Region, ajax, isClass } from 'bbmn-core';
...
var ExtView = mix(View).with(cssClassModifiersMixin, destroyViewMixin);
var ExtCollectionVIew = mix(CollectionView).with(customsMixin, nextCollectionViewMixin, emptyFetchMixin, improvedIndexesMixin, destroyViewMixin);
