...
import { betterResult, buildViewByKey, camelCase, flat, getOption, isEmptyValue, mix, triggerMethod, triggerMethodOn, unflat } from 'bbmn-utils';
...
var ExtCollectionVIew = mix(CollectionView).with(customsMixin, nextCollectionViewMixin, emptyFetchMixin, improvedIndexesMixin);
...
export { Process, startableMixin, App, store as ModelSchemas, ModelSchema, PropertySchema, validator, User, Token as BearerToken, ExtView as View, ExtCollectionVIew as CollectionView };
