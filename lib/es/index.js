...
import { BaseClass, Collection, Events, Model, Region, ajax, isClass, isCollection } from 'bbmn-core';
...
var BaseSelector = mix(BaseClass).with(Events);
