...
var ExtView = mix(View).with(optionsMixin, cssClassModifiersMixin);

var ExtCollectionVIew = mix(CollectionView).with(optionsMixin, cssClassModifiersMixin, customsMixin, emptyFetchMixin, improvedIndexesMixin);
