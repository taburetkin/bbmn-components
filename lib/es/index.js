...
import { BackboneView, BaseClass, Collection, Events, Model, Region, ajax, isClass, isCollection } from 'bbmn-core';
...
var Schema = mix(BaseClass).with(Events).extend({
	getOption: function getOption$$1() {
		return getOption.apply(undefined, [this].concat(Array.prototype.slice.call(arguments)));
	},
	triggerMethod: triggerMethod
...
var ClassStore = BaseClass.extend({
	constructor: function constructor() {
		var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
var BaseActionStore = BaseClass.extend({
	constructor: function constructor() {
		var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
