...
import BaseClass, { BaseClass as BaseClass$1, Collection, Events, Model, Region, ajax, isClass, isCollection } from 'bbmn-core';
...
var config = {
	...
	buildView: function buildView(options) {
		...
		var TextView$$1 = takeFirst('TextView', options, showOptions, this);
